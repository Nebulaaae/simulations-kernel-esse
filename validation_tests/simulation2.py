...
# print("--- Recherche des modules de géométrie dans OpenGate ---")
# for loader, name, ispkg in pkgutil.walk_packages(gate.__path__, gate.__name__ + "."):
#     if 'geometry' in name or 'voxel' in name:
